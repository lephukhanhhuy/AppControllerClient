...
#define DEVICE_IS_IPHONE_6 DEVICE_SCREEN_HAS_LENGTH__X([UIScreen mainScreen].bounds, 667.f)
...
- (void) btnGoSelected {
    ...
    if ((DEVICE_IS_IPHONE_3_5_In__X || DEVICE_IS_IPHONE_5__X || DEVICE_IS_IPHONE_6) && (orientation == UIInterfaceOrientationLandscapeRight || orientation == UIInterfaceOrientationLandscapeLeft)) {
